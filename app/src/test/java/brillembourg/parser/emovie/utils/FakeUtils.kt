...
data class MovieFake(val id: Long, val date: LocalDate = LocalDate.ofYearDay(1993, 1), val language: String = "en")

fun MovieFake.toDomain (): Movie {
    return Movie(id,"","",language, date,"","plot",200,3.4f)
}

data class TrailerFake (val id :String)

fun TrailerFake.toDomain(): Trailer {
    return Trailer(id,"key","name","youtube")
}
...
val movieDetailFake = MovieDetail(
    ...
    trailers = listOf(
        Trailer("1L", "kdfseref", "Trailer 1", "Youtube"),
        Trailer("2L", "kdfseref", "Trailer 2", "Youtube"),
    )
)

val trailerFakes = listOf(
    Trailer("1","Key1","Trailer1","Youtube"),
    Trailer("2","Key2","Trailer2","Youtube"),
    Trailer("3","Key3","Trailer3","Youtube"),
    Trailer("4","Key4","Trailer4","Youtube"),
)